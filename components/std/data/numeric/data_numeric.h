...
// makefiles, but I prefer to state these here in the code. This is
// essentially the namespace for the component.

#ifndef INCLUDED_COMPONENT_std_2009_data_numeric_0
#define INCLUDED_COMPONENT_std_2009_data_numeric_0
...
#else
    struct std_2009_data_numeric_0_Structure
    {
            // physical
...
#else
#define std_2009_data_numeric_0_F_GET_FOR_WRITE 0x0001
    struct std_2009_data_numeric_0_Content
    {
        TYPE type;
        const void* real;
        const void* imag;
...
#define std_2009_data_numeric_0_EVENT_DATA_STRUCTURE_GET (C_BASE_USER_EVENT + 1)
#define std_2009_data_numeric_0_EVENT_DATA_STRUCTURE_SET (C_BASE_USER_EVENT + 2)
#define std_2009_data_numeric_0_EVENT_DATA_VALIDATE_TYPE (C_BASE_USER_EVENT + 3)
#define std_2009_data_numeric_0_EVENT_DATA_VALIDATE_STRUCTURE (C_BASE_USER_EVENT + 4)
#define std_2009_data_numeric_0_EVENT_DATA_CONTENT_GET (C_BASE_USER_EVENT + 5)
#define std_2009_data_numeric_0_EVENT_DATA_CONTENT_SET (C_BASE_USER_EVENT + 6)
    ...
    */
    ...
    public:
        ...
        void fire()
            {
                // fire event
                std_2009_data_numeric_0::fireHandledEvent(&hev);
            }
    ...
    */
    ...
    {
    protected:
        std_2009_data_numeric_0::Content content;
...
#endif // INCLUDED_DATA_NUMERIC_std_2009_data_numeric_0
