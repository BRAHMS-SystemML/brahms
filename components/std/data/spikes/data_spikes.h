...
#ifndef INCLUDED_COMPONENT_std_2009_data_spikes_0
#define INCLUDED_COMPONENT_std_2009_data_spikes_0
...
struct std_2009_data_spikes_0_Spikes
{
	INT32* spikes;
	UINT32 count;
	UINT32 flags;
...
#define std_2009_data_spikes_0_EVENT_DATA_STRUCTURE_GET (C_BASE_USER_EVENT + 1)
#define std_2009_data_spikes_0_EVENT_DATA_STRUCTURE_SET (C_BASE_USER_EVENT + 2)
#define std_2009_data_spikes_0_EVENT_DATA_CONTENT_GET (C_BASE_USER_EVENT + 3)
#define std_2009_data_spikes_0_EVENT_DATA_CONTENT_SET (C_BASE_USER_EVENT + 4)
...
////////////////	UPDATE ALL THE ABOVE TOGETHER (FIELDS, CONSTRUCT, COPY)
		...
		{
			//	fire event
			std_2009_data_spikes_0::fireHandledEvent(&hev);
		}
