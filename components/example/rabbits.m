...
%__________________________________________________________________________
%
% $Id:: rabbits.m 2317 2009-11-07 22:10:20Z benjmitch                    $
% $Rev:: 2317                                                            $
% $Author:: benjmitch                                                    $
...
switch input.event.type
	...
	case persist.constants.EVENT_RUN_SERVICE
		...
		% read input
		foxes = input.iif.default.ports(1).data;
		...
		% update output
		output.operations{end+1} = ...
			{persist.constants.OPERATION_SET_CONTENT, persist.outputPortHandle, persist.rabbits};
