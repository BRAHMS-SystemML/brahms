...
#define ____CLASS_US_____EVENT_UTILITY_SELECT (C_BASE_USER_EVENT + 1)
#define ____CLASS_US_____EVENT_UTILITY_SEED (C_BASE_USER_EVENT + 2)
#define ____CLASS_US_____EVENT_UTILITY_FILL (C_BASE_USER_EVENT + 3)
#define ____CLASS_US_____EVENT_UTILITY_GET (C_BASE_USER_EVENT + 4)
