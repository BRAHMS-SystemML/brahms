/*
 * Reproduces the behaviour of the old brahms-1199.h, which was
 * constructed by concatenating brahms-c++-common.h,
 * brahms-c++-legacy.h and the in-source "stub" brahms-1199.h. Ill
 * advised.
 */
