...
#define VERSION_ENGINE_MAJ ( VERSION_BRAHMS_MAJ )
#define VERSION_ENGINE_MIN ( VERSION_BRAHMS_MIN )
#define VERSION_ENGINE_REL ( VERSION_BRAHMS_REL )
#define VERSION_ENGINE_REV ( VERSION_BRAHMS_REV )
...
// check success
#ifndef ARCH_BITS
 #error Compiler or architecture unrecognised - check top level CMakeLists.txt
#endif
...
#ifndef __NIX__
# ifndef __WIN__
#  error Platform unrecognised - define __WIN__, __GLN__ or __OSX__. Check top level CMakeLists.txt
# endif
#endif
...
#endif // INCLUDED_BRAHMS_COMPONENT_INTERFACE
